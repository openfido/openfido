...
class Application(CommonColumnsMixin, db.Model):
    ...
    application_system_permissions = db.relationship(
        "ApplicationSystemPermission", backref="application", lazy="select"
    )
...
class SystemPermission(CommonColumnsMixin, db.Model):
    ...
    application_system_permissions = db.relationship(
        "ApplicationSystemPermission", backref="system_permission", lazy="select"
    )
