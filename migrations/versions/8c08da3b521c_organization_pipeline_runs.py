...
def upgrade():
    ...
    op.create_table('post_processing_state',
    ...
    op.create_table('organization_pipeline_input_file',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('uuid', sa.String(length=32), server_default='', nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_table('organization_pipeline_run',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('uuid', sa.String(length=32), server_default='', nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('post_processing_pipeline_run_uuid', sa.String(length=32), server_default='', nullable=False),
    ...
    op.create_table('organization_pipeline_run_post_processing_state',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('uuid', sa.String(length=32), server_default='', nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['post_processing_state_id'], ['post_processing_state.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
