...
import { requestDeletePipelineRunChart } from 'services';
            ...
            <StyledH2 color="gray">
              <Space direction="vertical" size={16}>
                ...
                <p>
                  ...
                  {' '}
                  <br />
                  <StyledText color="pink">{chartName}</StyledText>
                </p>
                <p>
                  Please type in the artifact chart name
                  <br />
          ...
          <>
            ...
            <Space direction="vertical" size={36} align="center">
              <StyledText color="gray" size="large">
                Are you sure you want to delete this Artifacts Chart?
                {' '}
